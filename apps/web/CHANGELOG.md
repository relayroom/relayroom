...
- @relayroom/db@0.8.3
- @relayroom/shared@0.8.3
- @relayroom/telemetry@0.8.3
...
- 1429c8c: Dashboard pages no longer scroll sideways on narrow screens, and the project tab bar now shows you which tab you are on.
...
- 6c8601e: Detail pages no longer scroll sideways when a thread, agent or knowledge entry contains a long unbroken value.
  ...
  - @relayroom/db@0.8.1
  - @relayroom/shared@0.8.1
  - @relayroom/telemetry@0.8.1

## 0.8.0

### Minor Changes

- cc40f8b: The connect guide offers a tmux or herdr choice, and generates the right setup for whichever is picked.
...
- a9244c5: A part now shows which multiplexer it is actually delivering wakes through, and says when wakes are not getting through at all.
