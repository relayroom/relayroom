...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      render={render}
      // When rendered as a custom element (e.g. a Next.js <Link> -> <a>), it is
      // no longer a native <button>; tell base-ui so it drops button semantics
      // instead of warning. Explicit nativeButton still wins.
