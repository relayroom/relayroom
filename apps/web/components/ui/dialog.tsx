...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        // Match the close button's height (size-9 = 36px, aligned at top-6) so the
        // title and the X share a row and the description sits clearly below it.
        "flex min-h-9 items-center pr-10 font-heading text-lg leading-none font-semibold tracking-wider uppercase",
        className
      )}
      {...props}
    />
